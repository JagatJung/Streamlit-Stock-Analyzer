...
Shown are the stock **closing prices** and value of various companies!
""")
...
if(res>0):
    new_title = '<p style="font-family:sans-serif; color:green; font-size: 18px;"> Its probabily safe to buy it</p>'
    st.markdown(new_title, unsafe_allow_html=True)
else:
    new_title = '<p style="font-family:sans-serif; color:red; font-size: 18px;">Its not so fabourable</p>'
    st.markdown(new_title, unsafe_allow_html=True)
